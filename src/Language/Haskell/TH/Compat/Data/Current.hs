...
import Language.Haskell.TH
  (CxtQ, ConQ, TypeQ, DecQ,
   Cxt, Con, Type, Name, TyVarBndr (PlainTV, KindedTV), Specificity (SpecifiedSpec), Kind,
...
plainTVSpec :: Name -> TyVarBndr Specificity
plainTVSpec n = PlainTV n SpecifiedSpec
